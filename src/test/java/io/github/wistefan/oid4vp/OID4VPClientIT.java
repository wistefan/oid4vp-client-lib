    ...
    private static Stream<Arguments> provideRequests() {
        return Stream.of(
                ...
                Arguments.of(new RequestParameters(URI.create("http://localhost:8080"),
                                ...
                                null,
                                Set.of()),
                        "When requesting through the proxy, the process should properly go through the endpoint published under the test-service-sd using the default scope."),
                Arguments.of(new RequestParameters(URI.create("http://localhost:8080"),
                                "test-service-jwt",
                                null,
                                Set.of("openid")),
                ...
                Arguments.of(new RequestParameters(URI.create("http://localhost:8080"),
                                ...
                                null,
                                Set.of()),
                        "When requesting through the proxy, the process should properly go through the endpoint published under the test-service-jwt using the default scope."),
                Arguments.of(new RequestParameters(URI.create("http://localhost:3000"),
                                "services/test-service",
                                "test-service",
                                Set.of("default")),
                        "When requesting directly, the client-id test-service should be used with the scope `default`."),
                Arguments.of(new RequestParameters(URI.create("http://localhost:3000"),
                                "services/test-service",
                                "test-service",
                                Set.of()),
                        "When requesting directly, the client-id test-service should be used with the default scope."),
                Arguments.of(new RequestParameters(URI.create("http://localhost:3000"),
                                "services/test-service",
                                "test-service",
                                Set.of("sd")),
